...
project_path = '/Users/fuying/Downloads/Logram-master/'
...
doubleDictionaryList, triDictionaryList, allTokenList, log_contents = dictionaryBuilder_fy(BGL_format, project_path+'TestLogs/BGL_2k.log', BGL_Regex)
tokenMatch_fy(log_contents, allTokenList,doubleDictionaryList,triDictionaryList,92,4, project_path+'Output/BGL/')
# evaluate(project_path+'GroundTruth/Thunderbird_2k.log_templates.csv', project_path+'Output/BGL_template.csv')
