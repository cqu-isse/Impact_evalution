...
class LogParser:
    ...
    def outputResult(self, logClustL):
        ...
        if self.keep_para:
            ...
            self.df_log.to_csv(self.savePath+self.logName + '_structured.csv', index=False)
        ...
        df_event.to_csv(self.savePath + self.logName + '_templates.csv', index=False, columns=["EventId", "EventTemplate", "Occurrences"])
