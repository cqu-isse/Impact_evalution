...
from logdeep.dataset.sample import session_window,fixed_window
...
def generate(data_dir, name):
    ...
    hdfs = {}
    length = 0
    # data_dir = '/home/fuying/data_hub/for_deeplog/HDFS_log/parsing_by_Drain/normal_abnormal/'
...
class Predicter():
    def __init__(self, model, options):
        ...
        self.window_model = options['sample']
        self.template_num = options['num_templates']
    ...
    def predict_unsupervised(self):
        ...
        test_normal_loader, test_normal_length = generate(self.data_dir,'normal_abnormal/normal_test.txt')
        test_abnormal_loader, test_abnormal_length = generate(self.data_dir, 'normal_abnormal/abnormal_temp.txt')
        TP = 0
        FP = 0
        # Test the model
    ...
    def predict_supervised(self):
        ...
        if self.window_model == "session_window":
            test_logs, test_labels = session_window(self.data_dir, datatype='test',template_num=self.template_num)
        elif self.window_model == "fixed_window":
            test_logs, test_labels = fixed_window(self.data_dir, window_size=18, datatype='test',template_num=self.template_num)
        else:
            print("please check the window model!")
